...
router.post('/:lessonId/video', isAuth(), checkAdmin(), multercloudFunction(allowedExtensions.Videos).single('video'), addvideotoleason);
router.post('/:lessonId/assignment', isAuth(), checkAdmin(), upload.single('file'), uploadAssignment);
